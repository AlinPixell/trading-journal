          ...
          <Dialog.Content asChild>
            ...
            >
              ...
              <Dialog.Close asChild>
                <button
                  type="button"
                  className="absolute right-3 top-[calc(0.75rem+env(safe-area-inset-top,0px))] z-10 flex min-h-11 min-w-11 items-center justify-center rounded-md border border-[var(--border-soft)] bg-[var(--fx-05)] text-[var(--text-primary)] transition hover:bg-[var(--fx-09)] sm:right-4 sm:top-4 sm:min-h-0 sm:min-w-0 sm:p-2.5"
                  aria-label="Close"
                >
                  <X className="h-4 w-4" />
                </button>
